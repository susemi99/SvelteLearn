<script>
  ...
  function requestDifferntSizeImage(url, size = 700) {
...
<div class="container">
  ...
  {:else}
    <div class="movie-details">
      <div
        class="poster"
        style="background-image: url({requestDifferntSizeImage(
          $theMovie.Poster
        )});"
      >
        {#if imageLoading}
      ...
      <div class="specs">
        ...
        <div class="ratings">
          ...
          <div class="rating-wrap">
            {#each $theMovie.Ratings as rating}
              <div class="rating" title={rating.Source}>
                <img src="/assets/{rating.Source}.png" alt="" height="30" />
